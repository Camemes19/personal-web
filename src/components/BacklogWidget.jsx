    ...
    return (
        <div className={"mx-auto max-w-2/5 border-2 rounded-lg border-indigo-900 shadow-lg shadow-gray-950/30 p-2"}>
            ...
            <div className={"m-3 h-4 max-w-9/10 bg-gray-500 flex -skew-x-24 rounded-br-md rounded-tl-md"}>
                <div style={{width: `calc(100%*${unfinishedPercent}`}} className={"bg-red-500 flex rounded-tl-md" +
                    " drop-shadow-md" +
                ...
                <div style={{width: `calc(100%*${completePercent}`}} className={"bg-green-600 flex rounded-br-md" +
                    " drop-shadow-md" +
